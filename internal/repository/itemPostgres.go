...
func (r *ItemPostgres) Create(listId int, item model.TodoItem) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *ItemPostgres) GetAll(userId, listId int) ([]model.TodoItem, error) {
...
func (r *ItemPostgres) GetById(userId, itemId int) (model.TodoItem, error) {
...
func (r *ItemPostgres) Update(userId, itemId int, input model.UpadteItemInput) error {
	// Начинаем транзакцию
	tx, err := r.db.Begin()
	if err != nil {
		return err
